...
class CachedMessageController(
    ...
    fun createMessage(
        ...
        if (!cachedUserRepository.existsById(request.userId)) throw ServiceException("User doesn't exist!")
    ...
    fun getMessagesForUser(
        ...
        if (!cachedUserRepository.existsById(userId)) throw ServiceException("User doesn't exist!")
